...
export const userService = {
  ...
  updateProfileByUserId: (userId: string, { firstName, lastName }: { firstName: string; lastName: string }, session?: ClientSession) => {
  ...
  deleteById: (userId: string, session?: ClientSession) => User.deleteOne({ userId }, { session }),
